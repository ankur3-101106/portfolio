...
---
#### 8.4.4 Where Agile Methodology Does NOT Work

Agile is not suitable in all situations. It may fail or be less effective in the following cases:

* **Stable Requirements**

  * When requirements are clearly defined and unlikely to change.
  * Traditional models like Waterfall are more suitable.

* **Large Distributed Teams**

  * Agile requires strong communication and collaboration.
  * Difficult when teams are spread across locations.

* **Poor Understanding of Agile**

  * Teams without proper Agile knowledge may misuse practices.
  * Leads to confusion and inefficiency.

* **Lack of Customer Involvement**

  * Agile depends heavily on continuous customer feedback.
  * Without it, development may go in the wrong direction.
...
### 8.5 Traditional Process Models

In addition to Agile, several traditional models are used in software engineering.

---

#### 8.5.1 Waterfall Model
...
* No working product until late stages
* Errors discovered late

---

#### 8.5.2 Incremental Model

Software is developed in **small parts (increments)**, each delivering partial functionality.
...
#### 8.5.3 Prototype Model

A **prototype (initial version)** is developed to understand user requirements.
...
3. Build prototype
4. User evaluation
5. Refine and develop final system
...
* Prototype may be mistaken as final product
* Poor documentation
...
> Different development activities progress concurrently with state transitions.
