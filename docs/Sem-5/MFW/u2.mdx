...
Modules are the functional components of Metasploit.

On standard Debian-based Linux installations, the default modules are stored under:
`/usr/share/metasploit-framework/modules/`.

On standard Arch-based Linux installations, the default modules are stored under:
